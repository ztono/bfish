...
public class SmartQA {
    ...
    public String getIntend(String question) {
        String questionUrl = null;
        System.out.println("question" + question);
        try {
            questionUrl = URLEncoder.encode(question, "UTF-8");
        ...
        try {
            ...
            if(jsonObject.getJSONObject("entities").get("entity").toString()!=null){
                return jsonObject.getJSONObject("entities").get("entity").toString();
            }
