...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <div class="meun-item" href="#addUser" aria-controls="addUser" role="tab" data-toggle="tab"><img
                src="images/icon_source.png">修改信息
        </div>
        <div class="meun-title">器材查询</div>
        <div class="meun-item" href="#allEquipments" aria-controls="addUser" role="tab" data-toggle="tab"><img
                src="images/icon_source.png">器材查询
        </div>
        <div class="meun-title">记录查询</div>
        <div class="meun-item" href="#borrowHistory" aria-controls="borrowHistory" role="tab" data-toggle="tab"><img
                src="images/icon_char_grey.png">借用记录
        </div>
        <div class="meun-item" href="#returnHistory" aria-controls="returnHistory" role="tab" data-toggle="tab"><img
                src="images/icon_char_grey.png">归还记录
        </div>
    </div>
    <!-- 右侧具体内容栏目 -->
    <div id="rightContent">
                    ...
                    <div style="padding: 50px 0;margin-top: 50px;background-color: #fff; text-align: right;width: 420px;margin: 50px auto;">
                        <form class="form-horizontal" action="ModifyUserServlet" method="post">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-xs-8 ">
                                    <input type="" name="password" class="form-control input-sm duiqi" id="sPwd"
                                           placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-8 ">
                                    <input type="" name="realname" class="form-control input-sm duiqi" id="sReal"
                                           placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input type="" name="email" class="form-control input-sm duiqi" id="sEmail"
                                           placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input type="" name="Phone_Number" class="form-control input-sm duiqi" id="sPnum"
                                           placeholder="">
                                </div>
                            </div>
                            <div class="form-group" hidden>
                                ...
                                <div class="col-xs-8">
                                    <input type="" name="fine" class="form-control input-sm duiqi" id="sFine"
                                           placeholder="">
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <footer class="footer">
                        <ul class="pagination">
                            ...
                            <li><span id="spanPageNum"></span>/
                            <li><span id="spanTotalPage"></span></li>
                        </ul>
                    </footer>
                </div>
            </div>
