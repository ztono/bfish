...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <div class="meun-item" href="#searchRoom" aria-controls="searchRoom" role="tab" data-toggle="tab" id ="t3"><img src="images/icon_char_grey.png">查询空房</div>
    ...
    <div id="rightContent">
        ...
        <div class="tab-content">
            ...
            <!--空房查询-->
            .<div role="tabpanel" class="tab-pane" id="searchRoom">
            <div class="container">
                <div class="page-header">
                    <h1 align="center">空房查询</h1>
                </div>

                <form class="form-horizontal" action="searchRoomServlet" method="post">
                    <div class="form-inline" align="center">
                        <div>
                            <select  type="" name="room_type" id="cTyp" class="form-control" style="width: 150px;height: 30px;">
                            ...
                            <input type="date" name="arrivetime" class="form-control input-sm duiqi" id="arrD" placeholder="" style="width: 80px;height: 30px;position: relative;left: 30px;top: -3px;">

                            <input type="date" name="leavetime" class="form-control input-sm duiqi" id="leD" placeholder=""  style="width: 80px;height: 30px; position: relative;left: 60px;top: -3px;">

                            <button type="submit" class="btn btn-white btn-xs "  style="position: relative;left: 60px;height: 30px;">查 询 </button>
                        </div>
                    </div>
                </form>
                <table id="blockSearch" style="width: 800px; margin: 44px auto"
                       class="table table-striped table-bordered table-hover  table-condensed"
                       align='center' border='1' cellspacing='0'>
                    <tr>
                        <td align="center">序号</td>
...
<%--                    <%--%>
<%--                        List<Room> listroom = (List<Room>) request.getAttribute("roomlist");--%>

<%--                    %>--%>

<%--                    <% for(int i=0;i<listroom.size();i++)//再写一个for循环遍历--%>
<%--                        {%>--%>

<%--                    <tr >--%>
<%--                        <td><%=listroom.get(i).getRoom_no() %> </td>--%>
<%--                        <td><%=listroom.get(i).getRoom_id() %> </td>--%>
<%--                        <td><%=listroom.get(i).getRoom_type() %> </td>--%>
<%--                        <td><%=listroom.get(i).getRoom_state() %> </td>--%>
<%--                        <td><%=listroom.get(i).getRoom_price() %> </td>--%>
<%--                        <td><%=listroom.get(i).getRoom_location() %> </td>--%>

<%--                    </tr>--%>
<%--                    <%}--%>
<%--                    %>--%>
                    <c:forEach items="${sessionScope.roomList}" var="list"  >
                        <tr >
                            <td>${list.room_no}</td>
                            <td>${list.room_id}</td>
...
<%} %>
        <% if (request.getParameter("dsa")!= null) {%>
    <script type="text/javascript">
        $(document).ready(function(){
            $("#t3").click();
        });
